...
public class EbicsException extends Exception {
   ...
   */
  public EbicsException(EbicsReturnCode returnCode) {
   ...
   */
  public EbicsException(EbicsReturnCode returnCode, String message) {
    super(message);
    this.returnCode = returnCode;
  }

  public EbicsException(String message, Exception exception){
   ...
   */
  public EbicsReturnCode getReturnCode() {
    return returnCode;
  }
  ...
  private EbicsReturnCode 		returnCode;
