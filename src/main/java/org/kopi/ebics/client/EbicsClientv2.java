...
//     * @param properties
//     */
//    public EbicsClientv2(Configuration configuration, ConfigProperties properties) {
...
//    }
//
//    private org.kopi.ebics.session.EbicsSession createSessionOld(User user, Product product) {
//        org.kopi.ebics.session.EbicsSession session = new org.kopi.ebics.session.EbicsSession(user, configuration);
//        session.setProduct(product);
//        return session;
//    }
//
...
//            return;
//        }
//        org.kopi.ebics.session.EbicsSession session = createSessionOld(user, product);
...
//            System.out.println();
//            formatter.printHelp(EbicsClientv2.class.getSimpleName(), options);
//            System.out.println();
//            System.exit(0);
//        }
//        return line;
//    }
//
//    public static EbicsClientv2 createEbicsClient(File rootDir, File configFile) throws IOException {
...
//
//        EbicsConfiguration configuration = new EbicsConfiguration(rootDir.getAbsolutePath(),
...
//        };
//
//        EbicsClientv2 client = new EbicsClientv2(configuration, properties);
//
...
//        EbicsClientv2 client = createEbicsClient(defaultRootDir, ebicsClientProperties);
//
